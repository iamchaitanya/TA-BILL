...
export const SummaryPage: React.FC<SummaryPageProps> = ({
  ...
  return (
    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      <div className="bg-white rounded-[32px] border border-teal-100 p-8 shadow-sm space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-6 bg-slate-50 rounded-[24px] border border-slate-100 group hover:border-teal-200 transition-colors">
